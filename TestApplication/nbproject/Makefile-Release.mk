...
${OBJECTDIR}/_ext/deec58d5/gtest-all.o: ../googletest/googletest/src/gtest-all.cc
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/deec58d5/gtest-all.o ../googletest/googletest/src/gtest-all.cc

${OBJECTDIR}/_ext/deec58d5/gtest_main.o: ../googletest/googletest/src/gtest_main.cc
	${MKDIR} -p ${OBJECTDIR}/_ext/deec58d5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/deec58d5/gtest_main.o ../googletest/googletest/src/gtest_main.cc

${OBJECTDIR}/test1.o: test1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test1.o test1.cpp
